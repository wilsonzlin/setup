...
export sl_apache_spark_url='https://dlcdn.apache.org/spark/spark-3.3.0/spark-3.3.0-bin-hadoop3.tgz'
export sl_bat_url='https://github.com/sharkdp/bat/releases/download/v0.21.0/bat_0.21.0_amd64.deb'
export sl_delta_url='https://github.com/dandavison/delta/releases/download/0.13.0/git-delta_0.13.0_amd64.deb'
export sl_docker_compose_url='https://github.com/docker/compose/releases/download/v2.6.1/docker-compose-linux-x86_64'
export sl_flutter_url='https://storage.googleapis.com/flutter_infra_release/releases/stable/linux/flutter_linux_3.0.3-stable.tar.xz'
...
export sl_gitui_url='https://github.com/extrawurst/gitui/releases/download/v0.20.1/gitui-linux-musl.tar.gz'
export sl_golang_url='https://go.dev/dl/go1.18.3.linux-amd64.tar.gz'
export sl_hub_url='https://github.com/github/hub/releases/download/v2.14.2/hub-linux-amd64-2.14.2.tgz'
export sl_jetbrains_toolbox_url='https://download.jetbrains.com/toolbox/jetbrains-toolbox-1.24.12080.tar.gz'
export sl_maven_url='https://dlcdn.apache.org/maven/maven-3/3.8.6/binaries/apache-maven-3.8.6-bin.tar.gz'
export sl_mysql_apt_url='https://dev.mysql.com/get/mysql-apt-config_0.8.22-1_all.deb'
export sl_nvm_url='https://raw.githubusercontent.com/nvm-sh/nvm/v0.39.1/install.sh'
export sl_protobuf_url='https://github.com/protocolbuffers/protobuf/releases/download/v21.2/protoc-21.2-linux-x86_64.zip'
export sl_ripgrep_url='https://github.com/BurntSushi/ripgrep/releases/download/13.0.0/ripgrep_13.0.0_amd64.deb'
export sl_rstudio_url='https://download1.rstudio.org/desktop/jammy/amd64/rstudio-2022.02.3-492-amd64.deb'
